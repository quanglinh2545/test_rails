...
class MangasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create manga" do
    assert_difference('Manga.count') do
      post mangas_url, params: { manga: { author: @manga.author, genre: @manga.genre, title: @manga.title } }
    end
  ...
  test "should update manga" do
    patch manga_url(@manga), params: { manga: { author: @manga.author, genre: @manga.genre, title: @manga.title } }
